...
If desired, you can include a binary mediator instead of a numerical mediator, and specify that the TVEM part of the model use the logistic link function.  The easiest way to demonstrate this (although it usually would not be advisable for real data because it involves loss of information) is to dichotomize $M$ in the simulated dataset.
