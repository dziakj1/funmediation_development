...
#' \item{true_alpha_int}{True value of the time-varying alpha_int parameter, representing the time-specific mean of the mediator M when the treatment value X is 0.}
#' \item{true_alpha_X}{True value of the time-varying alpha_X parameter, representing the effect of X on M}
#' \item{true_beta_int}{True value of the beta_M parameter, representing the mean of the outcome Y when X=0 and M=0.}
#' \item{true_beta_M}{True value of the beta_M parameter, representing the functional effect of treatment on the outcome Y.}
#' \item{true_beta_X}{True value of the beta_X parameter, representing the effect of treatment on the outcome Y adjusting for the mediator.}
#' \item{true_indirect}{True value of the indirect parameter, representing the indirect (mediated) effect of treatment on the outcome Y.}
